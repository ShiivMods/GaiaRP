    ...
    "periods": [
      {
        ...
        "paragraphs": [
          ...
          "Au fil des années, ses membres passèrent progressivement du statut de terroristes à celui de révolutionnaires aux yeux d'une partie croissante de la population. Leur soutien populaire augmenta rapidement, tout comme l'ampleur de leurs opérations. En moins d'une décennie, les effectifs d'Humanis dépassèrent ceux des forces armées de certains petits États. L'organisation était désormais capable de frapper presque n'importe où, à n'importe quel moment.",
          ...
          "L'Asie fut placée sous l'autorité de la Chine, qui conserva son propre gouvernement en devenant un État vassal d'Humanis. Le Japon parvint quant à lui à préserver son indépendance en échange d'une démilitarisation complète.",
          "Les États-Unis et la Russie, tous deux déjà affaiblis par une importante régression économique, tentèrent alors de s'opposer conjointement à l'expansion d'Humanis.",
          "La réponse fut d'une brutalité sans précédent.",
          ...
          "Malgré ces pertes, les gouvernements américain et russe refusèrent toujours de capituler. Ils choisirent à leur tour l'escalade et lancèrent leurs arsenaux stratégiques contre les grandes métropoles européennes.",
          ...
          "La démonstration eut un effet dévastateur sur le moral des populations russes et américaines. Beaucoup refusèrent désormais de participer à une guerre auto-destructrice. Humanis disposait de ressources considérables, mais surtout de technologies que ses adversaires semblaient incapables d'égaler.",
          ...
          "À l'issue de la Guerre d'Unification, Humanis réorganisa les territoires sous son autorité autour de six grandes zones administratives.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Cette nouvelle société pose cependant un problème immédiat à Humanis : l'automatisation peut remplacer une immense quantité de travail humain, mais elle ne peut pas encore remplacer les connaissances nécessaires au développement du nouveau monde.",
          "De vastes campagnes d'éducation sont donc lancées. Les études deviennent largement accessibles et Humanis encourage particulièrement la formation de scientifiques, d'ingénieurs et de personnels de santé, considérés comme essentiels au développement des décennies à venir.",
          ...
          "Les progrès médicaux sont considérables. De nouveaux traitements apparaissent, les diagnostics assistés par intelligence artificielle se généralisent et certaines maladies autrefois difficiles à traiter voient leur mortalité s'effondrer.",
          "L'espérance de vie, qui aurait théoriquement dû augmenter rapidement, connaît cependant une progression beaucoup plus lente qu'espérée.",
    ...
    "periods": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "À cette époque, posséder son propre appareil spatial devient progressivement accessible à une partie de la population.",
          "Le terme de « vaisseau » reste cependant encore très généreux pour désigner ces engins.",
          "La majorité ne peut accueillir **qu'une seule personne**. Quelques modèles extrêmement coûteux, principalement utilisés par de grandes compagnies privées, peuvent transporter deux occupants. Ils sont petits, rudimentaires et rarement confortables.",
          "Les systèmes de propulsion occupent encore une part considérable de leur structure. Le peu d'espace restant est généralement consacré au stockage des marchandises, aux réserves nécessaires au voyage ou, dans certains cas, à l'installation d'un armement. Le confort est donc considéré comme secondaire.",
        ...
        "subsections": [
          {
            ...
            "paragraphs": [
              ...
              "La mort d'**Elias Kern**, en **2096**, marque un premier tournant majeur. Le fondateur d'Humanis meurt à l'âge exceptionnel de **98 ans**, après avoir exercé une influence politique directe ou indirecte pendant plus de soixante ans.",
              "Son successeur, **Lucius Valen**, est élu conformément aux institutions mises en place après la Guerre d'Unification. Cette élection eut cependant des conséquences durables sur l'avenir d'Humanis.",
              ...
              "Le gouvernement martien refuse de reconnaître l'autorité de Lucius Valen et prend rapidement le contrôle des infrastructures stratégiques placées sous sa juridiction. Très vite, Mars fait main basse sur les principales réserves de **Redium** destinées au système solaire intérieur et interrompt l'approvisionnement de la Terre et de la Lune.",
              ...
              "Le contrôle du Redium devient rapidement l'un des enjeux centraux du conflit. Les combats se déplacent naturellement vers les géantes gazeuses et leurs lunes, où se trouvent plusieurs des principales installations d'extraction de cette précieuse ressource.",
...
export const consciousSpecies = [
  ...
  { id: 'species-2', name: 'Espèce consciente 2', subtitle: 'À documenter' },
  { id: 'species-3', name: 'Espèce consciente 3', subtitle: 'À documenter' },
  { id: 'species-4', name: 'Espèce consciente 4', subtitle: 'À documenter' },
  { id: 'species-5', name: 'Espèce consciente 5', subtitle: 'À documenter' },
]
...
export const factions = [
  ...
  { id: 'faction-2', name: 'Faction 2', subtitle: 'À documenter', active: false },
  { id: 'faction-3', name: 'Faction 3', subtitle: 'À documenter', active: false },
  { id: 'faction-4', name: 'Faction 4', subtitle: 'À documenter', active: false },
  { id: 'faction-5', name: 'Faction 5', subtitle: 'À documenter', active: false },
]
...
export const structuredFaiths: ReligiousEntry[] = [
  {
    ...
    kind: 'structured',
    name: 'Foi 1',
    subtitle: 'Foi structurée de démonstration',
